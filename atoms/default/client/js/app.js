...
function createCards(data) {
    ...
    function showFinishCard(votesBiden, votesTrump) {
        ...
        d3.select('.finish-biden-win')
            ...
            .html(bidenBlueWall.length == 3 && bidenSwings.length < 2 && bidenGOP.length == 0 ? "You said Biden would reclaim the key states of <b>Michigan</b>, <b>Wisconsin</b> and <b>Pennsylvania</b>, taking him over the majority to victory." : (
                bidenBlueWall.length == 3 && bidenSwings.length >= 2 && bidenGOP.length == 0 ? "You said Biden would reclaim the key states of <b>Michigan</b>, <b>Wisconsin</b> and <b>Pennsylvania</b>, as well as winning the swing states of <b>" + (bidenSwings.slice(0, -1).join(', ') + '</b> and <b>' + bidenSwings.slice(-1)) + "</b> to take him over the majority to victory." : (
                    bidenBlueWall.length == 3 && bidenGOP.length == 1 ? "You said Biden would reclaim the key states of <b>Michigan</b>, <b>Wisconsin</b> and <b>Pennsylvania</b> and take the former Republican stronghold of <b>" + bidenGOP + "</b> to win the presidency." : (
                        bidenBlueWall.length == 3 && bidenGOP.length > 1 ? "You said Biden would reclaim the key states of <b>Michigan</b>, <b>Wisconsin</b> and <b>Pennsylvania</b> and take the former Republican strongholds of <b>" + (bidenGOP.slice(0, -1).join(', ') + '</b> and <b>' + bidenGOP.slice(-1)) + "</b> to win the presidency." : (
        ...
        d3.select('.finish-trump-win')
            .style('display', votesBiden < votesTrump ? 'block' : 'none')
            .html(trumpBlueWall.length == 3 && trumpSwings.length < 2 ? 'You said Trump would retain the key states of <b>Michigan</b>, <b>Wisconsin</b> and <b>Pennsylvania</b>, taking him over the majority to victory.' : (
                trumpBlueWall.length == 3 && trumpSwings.length >= 2 ? 'You said Trump would retain the key states of <b>Michigan</b>, <b>Wisconsin</b> and <b>Pennsylvania</b>, as well as the swing states of <b>' + (trumpSwings.slice(0, -1).join(', ') + '</b> and <b>' + trumpSwings.slice(-1)) + "</b> to win the presidency." : (
                    trumpBlueWall.length < 3 && trumpBlueWall.length > 1 ? 'You said Trump would retain <b>' + (trumpBlueWall.slice(0, -1).join(', ') + '</b> and <b>' + trumpBlueWall.slice(-1)) + "</b> and would win the swing states of <b> " + (trumpSwings.slice(0, -1).join(', ') + '</b> and <b>' + trumpSwings.slice(-1)) + "</b> to take him over the majority to victory." : "")))
